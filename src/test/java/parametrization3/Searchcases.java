...
public static WebDriver driver;
    ...
    public void para() throws IOException, InterruptedException  {
        ...
        FileInputStream fs = new FileInputStream(new File("C:\\grid\\data3.xlsx"));
        //create workbook
        ...
        System.out.println("last row used is :" + lastrow);
			...
			driver.findElement(By.xpath("/html/body/table[2]/tbody/tr[1]/td[2]/table/tbody/tr/td/fieldset/form/table/tbody/tr[2]/td[1]/table/tbody/tr[1]/td[2]/input")).sendKeys(un);
